# Generated by Django 2.2.7 on 2020-05-14 13:14
...
class Migration(migrations.Migration):
    ...
    replaces = [('entities', '0001_initial'), ('entities', '0002_auto_20200511_1409'), ('entities', '0003_auto_20200511_1516'), ('entities', '0004_auto_20200513_0907'), ('entities', '0005_auto_20200513_0916'), ('entities', '0006_bag_pid'), ('entities', '0007_auto_20200513_0934'), ('entities', '0008_auto_20200513_1631'), ('entities', '0009_auto_20200514_1026')]

    initial = True

    dependencies = [
        ('additional_data', '0002_auto_20200511_1516'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documents_photo', models.ImageField(null=True, upload_to='', verbose_name='Photo of documents')),
                ('receipt_photo', models.ImageField(null=True, upload_to='', verbose_name='Photo of receipt')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to='', verbose_name='Photo of document')),
                ('entity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='entities.Entity', verbose_name='Entity')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='entities.Entity', verbose_name='Entity')),
                ('harvest', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='carbonization_endings', to='entities.Package', verbose_name='Harvest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carbonization_beginnings', to='entities.Package', verbose_name='Plot ID')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('truck_id', models.CharField(max_length=16, verbose_name='Truck ID')),
                ...
                ('entity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='entities.Entity', verbose_name='Entity')),
                ('harvest', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transports', to='entities.Package', verbose_name='Harvest ID')),
            ],
            options={
                'abstract': False,
            },
